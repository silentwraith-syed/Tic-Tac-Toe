...
start:
    ...
    if (g == 1)
    {
        ...
        for (int l = 0; l < 9; l++)
        {
            ...
            tac:
                ...
                if (p >= 10 || p <= 0)
                {
                    cout << "\n                             Invalid Choice! Choice should be between 1 to 9";
                    goto tac;
                }
    ...
    else if (g == 3)
    {
        ...
        cout << "The credits of the above game goes to Syed Mehran Ahmed for all programming \n\n";
        system("pause");
        goto start;
    }
    else
